 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 var EXPORTED_SYMBOLS = ["TwitterUrl"];
...
//dl("\nLoading twitterUrl.jsm");
//dl('Cc["@mesquilla.com/sgurl;1"] at load is ' + Cc["@mesquilla.com/sgurl;1"]);

function TwitterUrl()
{ try {
  //dl('Cc["@mesquilla.com/sgurl;1"] at construct is ' + Cc["@mesquilla.com/sgurl;1"]);
