...
tweequilla.noidentOverlay = function _noidentOverlay()
{ try {
  ...
  {
    emptyTrashOnExit.hidden = (account.incomingServer.type == 'twitter') ? true : oldHidden;
  }
...
window.addEventListener("load", function() {tweequilla.noidentOverlay();}, false);
